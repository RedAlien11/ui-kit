...
var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/redalien/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/redalien/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? '/images/redalien/LogoTextNewDark.png' : '/images/redalien/LogoTextNewWhite.png' })));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/redaliendefi/",
            },
            {
                label: "Docs",
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/redaliendefi",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/redaliendefi",
    },
];
var MENU_HEIGHT = 64;
        ...
        React__default['default'].createElement(Container$3, null, links.map(function (entry) {
            ...
            if (entry.items) {
                ...
                return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                    entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { disabled: entry.disabled, key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                        React__default['default'].createElement(MenuLink, { href: item.href },
                            React__default['default'].createElement(LinkLabel, { isPushed: isPushed }, item.label),
                            item.status && (React__default['default'].createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, item.status.text))))); })));
            }
            return (React__default['default'].createElement(MenuEntry, { disabled: entry.disabled, key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
